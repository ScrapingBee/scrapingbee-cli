...
def build_tests(fx: dict[str, str]) -> list[Test]:
    ...
    tests += [
        Test(
            ...
            ["scrape", "--output-file", fx["page_html"], "https://example.com"],
    ...
    tests += [
        ...
        Test(
            ...
            ["google", "--extract-field", "organic_results.url", "python"],
            one_url_per_line(),
        ),
        Test(
            "GG-22",
            "google batch",
            ["google", "--output-dir", fx["google_batch_dir"], "--input-file", fx["gs_file"]],
    ...
    tests += [
        ...
        Test(
            "AP-03",
            "amazon-product --domain co.uk",
            ["amazon-product", "B09B8YWXDF", "--domain", "co.uk"],
            json_key("product_name"),
        ),
        Test(
            "AP-04",
            "amazon-product --domain de",
            ["amazon-product", "B0BMB9RHTG", "--domain", "de"],
            json_key("product_name"),
        ),
        Test(
            "AP-05",
            "amazon-product --domain fr",
            ["amazon-product", "B09B8RF4PY", "--domain", "fr"],
            json_key("product_name"),
        ),
        Test(
            "AP-06",
    ...
    tests += [
        ...
        Test(
            ...
            ["amazon-search", "kopfhörer", "--domain", "de"],
            json_key("products"),
        ),
        Test(
            "AS-12",
            "amazon-search UK domain",
            ["amazon-search", "headphones", "--domain", "co.uk"],
            json_key("products"),
        ),
        Test(
            "AS-13",
        ...
        Test(
            "AS-17",
            "amazon-search batch",
            ["amazon-search", "--output-dir", fx["az_batch_dir"], "--input-file", fx["az_file"]],
    ...
    tests += [
        ...
        Test(
            ...
            ["youtube-search", "--extract-field", "results.link", "rick astley"],
    ...
    tests += [
        ...
        Test(
            ...
            ["youtube-metadata", "--output-dir", fx["yt_batch_dir"], "--input-file", fx["yt_file"]],
    ...
    tests += [
        ...
        Test(
            "CG-03",
            "chatgpt batch",
            ["chatgpt", "--output-dir", fx["cg_batch_dir"], "--input-file", fx["cg_file"]],
    ...
    tests += [
        Test(
            ...
            "schedule --help",
            ["schedule", "--help"],
            combined_checks(stdout_contains("--every")),
        ),
    ]
